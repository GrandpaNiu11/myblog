  ...
  <v-app-bar app :class="navClass" hide-on-scroll flat height="60">
    ...
    <div class="d-md-block d-none nav-container">
      ...
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <a class="menu-btn" href="http://193.112.190.161:8101/ScreenPage">
            <i class="iconfont iconlianjie" /> 大屏模拟
          </a>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/wangyiyun">
            <i class="iconfont iconfanhuidingbu" /> 网易云模拟
          </router-link>
        </div>
