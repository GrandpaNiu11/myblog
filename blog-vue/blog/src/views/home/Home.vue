<template>
  <div>
    ...
    <div class="home-banner" >
      <div class="video-box" style="width: 100% ;height: 100% ;background-color:red"  >
      <video preload="auto"     loop playsinline autoplay  width= 100% height= 100% style=" object-fit: fill;"
             src="@/12112.mp4" tabindex="-1"
             muted="muted"  ></video>
        <!-- 联系方式 -->
        <h1 class=" animated zoomIn fudong "  >
          {{ blogInfo.websiteConfig.websiteName }}
        </h1>
        
        <!-- 一言 -->
        <div class="blog-intro fudong1"   >
          <span class=" animated zoomIn">{{ obj.output }}   <span class="typed-cursor"> |</span></span>
        </div>
      </div>
