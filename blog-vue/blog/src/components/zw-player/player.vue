...
export default {
  ...
  data() {
    return {
      ...
      playState: true,
      playIcon: pause,
      musicImg: "http://p2.music.126.net/Gm2v1KrDe2TwplzxcmTxYg==/109951168428025131.jpg?param=130y130",
      musicUrl: "https://szrblog.oss-cn-beijing.aliyuncs.com/articles/%E5%88%98%E5%A4%A7%E6%8B%BF%20-%20%E6%88%91%E4%BB%AC%E7%9A%84%E6%AD%8C.mp3",
      musicWords: [
        "作词 : 王力宏",
        "作曲 : 王力宏",
        "作词 : 王力宏",
        ...
        "原唱 : 王力宏",
        "编曲 : 黄一",
        "授权声明 : 此版本为正式授权翻唱作品。未经著作权人许可，不得翻唱、翻录或使用",
...
<!--<template>-->
<!--  <aplayer :audio="audio" :lrcType="3" fixed mini ref="aplayer"/>-->
<!--</template>-->
...
<!--          artist: '泠鸢yousa',-->
<!--          url: 'https://szrssss.oss-cn-hangzhou.aliyuncs.com/music/winD%20-%20%E3%81%8B%E3%82%8F%E3%81%84%E3%81%84.mp3',-->
